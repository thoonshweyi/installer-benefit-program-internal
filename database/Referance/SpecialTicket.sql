...
select bb.sale_cash_document_datenow::date,depositdate,sale_cash_document_no1 as saleinvoiceno,gbh_customer_id,sale_id as sale_cash_document_id
                        ...
                        and depositdate::date between '$lucky_draw->start_date' and '$lucky_draw->end_date'
                        and (sale_cash_document_datenow::date-14 between '$lucky_draw->start_date' and '$lucky_draw->end_date')
                        )bb
                        Inner join
                        (
                            Select *
