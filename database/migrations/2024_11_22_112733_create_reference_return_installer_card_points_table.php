...
class CreateReferenceReturnInstallerCardPointsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('reference_return_installer_card_points', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('reference_return_installer_card_points');
    }
}
