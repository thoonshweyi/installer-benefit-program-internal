...
<table class="table table-striped table-hover table-bordered bg-white ">
    ...
    <tr height="30">
        <td colspan="9" style="word-wrap: break-word; text-align:center; margin:auto;">Coupon Number for Promotion Name : {{ $promotion->name }}</td>
    </tr>
    ...
    <tr style="word-wrap: break-word; text-align:center;">
        ...
        @foreach($lanthit[2] as $lan_day)
            <th width="15" style="text-align:center;"> Day {{ $j}}</th>
            @php $j++ @endphp
        @endforeach
    </tr>
