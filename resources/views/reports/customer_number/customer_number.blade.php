        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="d-flex flex-wrap flex-wrap align-items-center justify-content-between mb-4">
                    <div>
                        <h4 class="mb-3">{{__('report.customer_number')}}</h4>
                    </div>
                </div>
            </div>
                        ...
                        return `
                                <div class="d-flex align-items-center list-action">
                                    <a class="badge bg-secondary mr-2" data-toggle="tooltip" data-placement="top" title="Table_Report" data-original-title="Edit"
                                        href="/reports/customer_number/${row.uuid}"><i class="ri-eye-line mr-0"></i></a>

                                    <a class="badge bg-info mr-2" data-toggle="tooltip" data-placement="top" title="Chart_Report" data-original-title="Edit"
                                        href="/reports/customer_number_detail_graph/${row.uuid}"><i class="ri-line-chart-line mr-0"></i></a>
                                    @can('export-report')
                                    <a class="badge bg-success mr-2" data-toggle="tooltip" data-placement="top" title="Excel_Report" data-original-title="Edit"
                                        href="/reports/customer_number_detail_export/${row.uuid}"><i class="ri-file-excel-2-line mr-0"></i></a>
                                    @endcan
                                </div>`
                    }
                }
