        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="d-flex flex-wrap flex-wrap align-items-center justify-content-between mb-4">
                    <div>
                        <h4 class="mb-3">{{__('reports.ticket_history_detail')}} - Promotion 1 </h4>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-12 d-flex mb-2">
                <div class="form-row col-md-2">
                    <label>{{__('reports.invoice_no')}} </label>
                    <input type="text" class="form-control" id="lucky_draw_name" value="">
                </div>
                <div class="form-row col-md-2">
                    <label>{{__('lucky_draw.lucky_draw_type')}} </label>
                    <select id="lucky_draw_type" class="form-control ">
