                     ...
                     <div class="card-body p-0">
                        <div class="d-flex align-items-center auth-content">
                           <div class="col-lg-7 align-self-center">
                              <div class="p-3">
                                 <h4 class="mb-2">Lucky Draw System</h4>
                                 <p>Version 2</p>
                                    ...
                                    <div class="row">
                                       <div class="col-lg-12">
                                          <div class="floating-label form-group">
                                                <input class="floating-input form-control keyboardType0 jQKeyboard"  name="login_value" value="{{ $employee_id }}" placeholder="" autofocus required>
                                       ...
                                       <div class="col-lg-12">
                                            <div class="floating-label form-group">
                                                <input class="floating-input form-control keyboardType0 jQKeyboard" name="password" type="password" placeholder="" required value="{{ $password }}">
