                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="nrc_no" id="nrc_no" class="form-control" >
                                                            @foreach($nrc_nos as $nrc_no)
                                                                <option value="{{ $nrc_no->nrc_num_id}}"
                                                                    @if(isset($customer))
                                                                    {{$nrc_no->nrc_num_id == $customer->nrc_no ?
                                                                        'selected' : ''}}
                                                                    @endif>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="nrc_name" id="nrc_name" class="form-control" >
                                                            @foreach($nrc_names as $nrc_name)
                                                                <option value="{{ $nrc_name->nrc_id}}"
                                                                    @if(isset($customer))
                                                                    {{$nrc_name->nrc_id == $customer->nrc_name ?
                                                                        'selected' : '' }}
                                                                    @endif>
                                                                    {{ $nrc_name->district}}
                                                                </option>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="nrc_short" id="nrc_short" class="form-control">
                                                            @foreach($nrc_naings as $nrc_naing)
                                                                ...
                                                                <option value="{{ $nrc_naing->shortid}}"
                                                                    @if(isset($customer))
                                                                    {{$nrc_naing->shortid == $customer->nrc_short ?
                                                                        'selected' : '' }}
                                                                    @endif>
                                                                    {{ $nrc_naing->shortname}}
                                                                </option>
