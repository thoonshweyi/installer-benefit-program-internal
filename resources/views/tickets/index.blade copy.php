                    ...
                    <table class="table mb-0 tbl-server-info" id="ticket_header_list">
                        <thead class="bg-white text-uppercase">
                            <tr class="ligth ligth-data">
                                ...
                                <th>{{__('ticket.printed_status')}}</th>
            ...
            columns: [
                {
                    ...
                    render: function(data, type, row) {
                        return ` <a class="normal_status" title="Edit" href="/tickets/collect_invoice/${row.uuid}/edit">${data}</a>`;
                    }
                },
                {
                    data: 'invoice_no',
                        ...
                        if (row.status == 2) {
                            return `<div class="d-flex align-items-center list-action">
                                    <a class="badge bg-success mr-2" data-toggle="tooltip" data-placement="top" title="Edit" data-original-title="Edit"
                                        href="/tickets/collect_invoice/${row.uuid}"/edit><i class="ri-eye-line mr-0"></i></a>
                                </div>`
                        }
