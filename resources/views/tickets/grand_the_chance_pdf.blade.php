...
<style>
    .upn {
        ...
        background-image: url('/images/ticket_layout/grab_the_chance.png');
   ...
   @if($d['prize_type'] == 2)
        <div class="upn">
               <h4 class="date">{{ $d['ticket_date'] }}</h4>
                ...
                <div class="image_div">
                    <img class="prize_img" style=" margin-top:0px;height:150px;" src="{{ asset('/images/promotion_images')}}/{{ $d['promotion_uuid'] }}/{{ $d['sub_promotion_uuid'] }}/promotion_image/{{ $d['image'] }}">
                </div>
                <div class="word_div">
