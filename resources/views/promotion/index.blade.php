                    ...
                    <table class="table mb-0 tbl-server-info" id="lucky_draw_list">
                        <thead class="bg-white text-uppercase">
                            <tr class="ligth ligth-data">
                                ...
                                <th>{{__('lucky_draw.promotion_type')}}</th>
        ...
        var table = $('#lucky_draw_list').DataTable({
            ...
            columns: [{
                    ...
                    render: function(data, type, row) {
                        return `<a href="/new_promotion/${row.uuid}/edit" class="normal_status">${data}</a>`;
                    }
                },
                {
                    data: 'promotion_type',
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        if(data == 1){
                            return `<a href="/new_promotion/${row.uuid}/edit" class="normal_status">Active</a>`;
                        }else if(data == 2){
                            return `<a href="/new_promotion/${row.uuid}/edit" class="reject_status">Inactive</a>`;
                        }else if(data == 3){
                            return `<a href="/new_promotion/${row.uuid}/edit" class="reject_status">Pending</a>`;
                        }
                    }
                },
                {
                        ...
                        return `
                                <div class="d-flex align-items-center list-action">
                                    <a class="badge bg-success mr-2" data-toggle="tooltip" data-placement="top" title="Edit" data-original-title="Edit"
                                        href="/new_promotion/${row.uuid}/edit"><i class="ri-pencil-line mr-0"></i></a>
        ...
        table.on('click', '#delete', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: '/new_promotion/' + lucky_draw_id,
                        type: 'Delete',
                        dataType: 'JSON',
                        data: {
                            "_token": token,
